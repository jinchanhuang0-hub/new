...
export const productItems = {
  ...
  "custom-gold-snowflake-metal-ornament": {
    ...
    categoryHref: "/products/others",
    material: "Zinc alloy",
    process: "Die casting, polishing, gold plating and hanging cord assembly",
    sku: "UP-OTH-012",
    usage: "Christmas gifts, seasonal retail programs, holiday events and branded ornaments",
    categories: "Others, Christmas Metal Ornaments, Holiday Gifts",
    quoteProduct: "Others",
    lead: "This custom gold snowflake metal ornament uses an openwork snowflake shape, polished finish and hanging cord for Christmas gifts, seasonal retail programs and holiday events."
  },
  "custom-christmas-tree-metal-ornament": {
    ...
    categoryHref: "/products/others",
    material: "Zinc alloy",
    process: "Die casting, color filling, gold plating and hanging ribbon assembly",
    sku: "UP-OTH-011",
    usage: "Christmas gifts, seasonal retail programs, holiday events and branded ornaments",
    categories: "Others, Christmas Metal Ornaments, Holiday Gifts",
    quoteProduct: "Others",
    lead: "This custom Christmas tree metal ornament combines a shaped holiday design, enamel color and a hanging ribbon for seasonal gifts, retail collections and event merchandise."
  },
  "custom-snowman-metal-ornament": {
    ...
    process: "Die casting, color filling, gold plating and hanging ribbon assembly",
    sku: "UP-OTH-010",
    usage: "Christmas gifts, holiday events, seasonal retail programs and branded ornaments",
    categories: "Others, Christmas Metal Ornaments, Holiday Gifts",
    quoteProduct: "Others",
    lead: "This custom snowman metal ornament features a festive enamel design and hanging ribbon for Christmas gift programs, retail collections and seasonal event merchandise."
  },
  "custom-candy-cane-metal-ornament": {
    ...
    categories: "Others, Christmas Metal Ornaments, Holiday Gifts",
    quoteProduct: "Others",
    lead: "This custom candy cane metal ornament pairs a classic holiday shape with colored enamel and a hanging ribbon for retail displays, gifts and Christmas promotions."
  },
  "custom-gingerbread-man-metal-ornament": {
    ...
    categories: "Others, Christmas Metal Ornaments, Holiday Gifts",
    quoteProduct: "Others",
    lead: "This custom gingerbread man metal ornament uses a familiar holiday character, enamel color and a hanging ribbon for Christmas gift sets, events and seasonal retail programs."
  },
  "custom-classic-snowflake-metal-ornament": {
    ...
    categoryHref: "/products/others",
    material: "Zinc alloy",
    process: "Die casting, polishing, gold plating and hanging ribbon assembly",
    sku: "UP-OTH-007",
    usage: "Christmas gifts, seasonal retail programs, holiday events and branded ornaments",
    categories: "Others, Christmas Metal Ornaments, Holiday Gifts",
    quoteProduct: "Others",
