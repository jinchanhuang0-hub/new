    ...
    <section class="product-type-section" data-product-content="patchs" hidden>
      <div class="container product-type-content">
        ...
        <div class="product-type-grid custom-category-grid">
          ...
          <article class="product-type-card"><a class="product-type-media" href="/products/custom-patchs/custom-woven-dragon-round-patch"><img src="assets/images/custom-woven-dragon-round-patch.webp" width="800" height="800" alt="Blue and gold custom woven dragon round patch"></a><h2><a href="/products/custom-patchs/custom-woven-dragon-round-patch">Custom Woven Dragon Round Patch</a></h2><p>Blue and gold woven artwork with a stitched border for uniforms, apparel, bags, luggage and event programs.</p><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-patchs/custom-woven-dragon-round-patch">View Details</a><a class="product-type-btn product-type-btn-primary" href="/contact?product=Patchs&amp;item=Custom%20Woven%20Dragon%20Round%20Patch">GET A QUOTE</a></div></article>
          <article class="product-type-card"><a class="product-type-media" href="/products/custom-patchs/custom-embroidered-cartoon-character-patch"><img src="assets/images/custom-embroidered-cartoon-character-patch.webp" width="800" height="800" alt="Custom embroidered cartoon character patch"></a><h2><a href="/products/custom-patchs/custom-embroidered-cartoon-character-patch">Custom Embroidered Cartoon Character Patch</a></h2><p>Textured embroidery, bright color areas and a stitched border for apparel, uniforms, bags, toys and events.</p><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-patchs/custom-embroidered-cartoon-character-patch">View Details</a><a class="product-type-btn product-type-btn-primary" href="/contact?product=Patchs&amp;item=Custom%20Embroidered%20Cartoon%20Character%20Patch">GET A QUOTE</a></div></article>
        </div>
      </div>
    </section>
