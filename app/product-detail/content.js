...
export const productDetailHtml = String.raw`
  ...
  <main class="product-types-page" id="custom-details">
    ...
    <section class="product-type-section" data-product-content="coins" hidden>
      <div class="container product-type-content">
        <div class="product-type-head"><h1>Custom Challenge Coins</h1><p>Challenge coins and commemorative coins for military units, public service organizations, corporate teams and collector programs. Not sure how to turn artwork into production-ready specifications? <a href="/blog/how-custom-challenge-coins-are-made">Learn how custom challenge coins are made</a>, then <a href="/blog/military-challenge-coin-traditions">explore military challenge coin traditions and etiquette</a> before requesting a quote.</p></div>
