  ...
  <main class="product-types-page" id="custom-details">
    <section class="product-type-section" data-product-content="pins">
      <div class="container product-type-content">
        ...
        <div class="product-type-grid">
          <article class="product-type-card"><img src="assets/images/type-pins-soft-enamel.jpg" alt="Custom soft enamel pins"><h3>Green Character Soft Enamel Pin Set</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-enamel-pins/green-character-soft-enamel-pin-set">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-pins-hard-enamel.jpg" alt="Custom hard enamel pins"><h3>Box Cat and Umbrella Cat Enamel Pins</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-enamel-pins/box-cat-and-umbrella-cat-enamel-pins">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-pins-die-struck.jpg" alt="Die struck custom metal pins"><h3>Antique Silver Guitar Crest Enamel Pin</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-enamel-pins/antique-silver-guitar-crest-enamel-pin">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-pins-printed.jpg" alt="Printed custom lapel pins"><h3>Glitter Tour Truck Printed Enamel Pin</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-enamel-pins/glitter-tour-truck-printed-enamel-pin">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
        </div>
      </div>
    </section>
    ...
    <section class="product-type-section" data-product-content="medals" hidden>
      <div class="container product-type-content">
        ...
        ${productCategoryNavHtml({ active: "pins", variant: "inline" })}
        <div class="product-type-grid">
          <article class="product-type-card"><img src="assets/images/type-medals-sports.png" alt="Custom sports medals"><h3>Silver Basketball Sports Medal with Ribbon</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-medals/silver-basketball-sports-medal-with-ribbon">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-medals-3d.png" alt="3D custom award medals"><h3>3D Shield Logo Award Medal</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-medals/3d-shield-logo-award-medal">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-medals-award.png" alt="Custom commemorative medals"><h3>Silver Race Award Medal with Ribbon</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-medals/silver-race-award-medal-with-ribbon">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-medals-ribbon.png" alt="Custom medals with ribbon"><h3>Blue Marathon Ribbon Medal</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-medals/blue-marathon-ribbon-medal">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
        </div>
      </div>
    </section>
    ...
    <section class="product-type-section" data-product-content="coins" hidden>
      <div class="container product-type-content">
        ...
        ${productCategoryNavHtml({ active: "pins", variant: "inline" })}
        <div class="product-type-grid">
          <article class="product-type-card"><img src="assets/images/type-coins-3d.jpg" alt="Custom 3D challenge coins"><h3>3D Antique Firefighter Challenge Coins</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-challenge-coins/3d-antique-firefighter-challenge-coins">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-coins-double-sided.jpg" alt="Double sided challenge coins"><h3>Double Sided Anniversary Challenge Coin</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-challenge-coins/double-sided-anniversary-challenge-coin">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-coins-cut-shape.jpg" alt="Cut to shape challenge coins"><h3>Cut Shape Route Map Challenge Coin</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-challenge-coins/cut-shape-route-map-challenge-coin">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-coins-antique.jpg" alt="Antique plated challenge coins"><h3>Antique Military Squadron Challenge Coins</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-challenge-coins/antique-military-squadron-challenge-coins">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
        </div>
      </div>
    </section>
    ...
    <section class="product-type-section" data-product-content="keychains" hidden>
      <div class="container product-type-content">
        ...
        ${productCategoryNavHtml({ active: "pins", variant: "inline" })}
        <div class="product-type-grid">
          <article class="product-type-card"><img src="assets/images/type-keychains-metal.jpg" alt="Custom metal keychains"><h3>Colorful Flower Metal Keychains</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-metal-keychains/colorful-flower-metal-keychains">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-keychains-enamel.jpg" alt="Enamel custom keychains"><h3>Palm Island Enamel Keychain</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-metal-keychains/palm-island-enamel-keychain">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-keychains-opener.jpg" alt="Bottle opener keychains"><h3>Round School Logo Keychain</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-metal-keychains/round-school-logo-bottle-opener-keychain">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-keychains-spinner.jpg" alt="Spinner custom keychains"><h3>Travel Charm Spinner Keychain</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-metal-keychains/travel-charm-spinner-keychain">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
        </div>
      </div>
    </section>
    ...
    <section class="product-type-section" data-product-content="magnets" hidden>
      <div class="container product-type-content">
        ...
        ${productCategoryNavHtml({ active: "pins", variant: "inline" })}
        <div class="product-type-grid">
          <article class="product-type-card"><img src="assets/images/type-magnets-enamel.png" alt="Custom enamel fridge magnets"><h3>Ornate Building Enamel Fridge Magnet</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-fridge-magnets/ornate-building-enamel-fridge-magnet">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-magnets-3d.png" alt="3D custom fridge magnets"><h3>Ferris Wheel 3D Metal Fridge Magnet</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-fridge-magnets/ferris-wheel-3d-metal-fridge-magnet">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-magnets-soft-pvc.png" alt="Soft PVC fridge magnets"><h3>Cartoon Character Soft Fridge Magnet</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-fridge-magnets/cartoon-character-soft-pvc-fridge-magnet">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-magnets-souvenir.png" alt="Souvenir fridge magnets"><h3>City Landmark Souvenir Fridge Magnet</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-fridge-magnets/city-landmark-souvenir-fridge-magnet">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
        </div>
      </div>
    </section>
    ...
    <section class="product-type-section" data-product-content="bottle-openers" hidden>
      <div class="container product-type-content">
        ...
        <div class="product-type-grid compact">
          <article class="product-type-card"><img src="assets/images/type-openers-coin.jpg" alt="Custom coin bottle openers"><h3>Playing Card Metal Bottle Opener</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-bottle-openers/playing-card-metal-bottle-opener">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-openers-keychain.jpg" alt="Custom keychain bottle openers"><h3>Skull Coin Keychain Bottle Opener</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-bottle-openers/skull-coin-keychain-bottle-opener">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
        </div>
      </div>
    </section>
    ...
    <section class="product-type-section" data-product-content="buckles" hidden>
      <div class="container product-type-content">
        ...
        ${productCategoryNavHtml({ active: "pins", variant: "inline" })}
        <div class="product-type-grid">
          <article class="product-type-card"><img src="assets/images/type-buckles-western.jpg" alt="Western custom belt buckles"><h3>Western Skull Relief Belt Buckle</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-belt-buckles/western-skull-relief-belt-buckle">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-buckles-logo.jpg" alt="Logo custom belt buckles"><h3>Oval Relief Logo Metal Belt Buckle</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-belt-buckles/oval-relief-logo-metal-belt-buckle">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-buckles-antique.jpg" alt="Antique custom belt buckles"><h3>Antique Silver Rectangle Logo Belt Buckle</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-belt-buckles/antique-silver-rectangle-logo-belt-buckle">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-buckles-enamel.jpg" alt="Enamel custom belt buckles"><h3>Oval Club Logo Enamel Belt Buckle</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-belt-buckles/oval-club-logo-enamel-belt-buckle">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
        </div>
      </div>
    </section>
    ...
    <section class="product-type-section" data-product-content="golf-accessories" hidden>
      <div class="container product-type-content">
        ...
        ${productCategoryNavHtml({ active: "pins", variant: "inline" })}
        <div class="product-type-grid compact">
          <article class="product-type-card"><img src="assets/images/type-golf-ball-marker.jpg" alt="Custom golf ball markers"><h3>Antique Golf Club Divot Tool Ball Marker</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-golf-accessories/antique-golf-club-divot-tool-ball-marker">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-golf-hat-clip.jpg" alt="Custom golf hat clips"><h3>Avocado Golf Hat Clip Ball Marker</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-golf-accessories/avocado-golf-hat-clip-ball-marker">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-golf-divot-tool.jpg" alt="Custom golf divot tools"><h3>Color Logo Golf Divot Tool Set</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-golf-accessories/color-logo-golf-divot-tool-set">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
        </div>
      </div>
    </section>
    ...
    <section class="product-type-section" data-product-content="cufflinks-tieclips" hidden>
      <div class="container product-type-content">
        ...
        ${productCategoryNavHtml({ active: "pins", variant: "inline" })}
        <div class="product-type-grid compact">
          <article class="product-type-card"><img src="assets/images/type-cufflinks-metal.jpg" alt="Custom metal cufflinks"><h3>Blue Carbon Fiber Metal Cufflinks</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-cufflinks-tie-clips/blue-carbon-fiber-metal-cufflinks">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-cufflinks-enamel.jpg" alt="Custom enamel cufflinks"><h3>Color Plated Metal Tie Clips</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-cufflinks-tie-clips/color-plated-metal-tie-clips">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
          <article class="product-type-card"><img src="assets/images/type-tie-clips-logo.jpg" alt="Custom logo tie clips"><h3>Black Skull Logo Cufflinks</h3><div class="product-type-actions"><a class="product-type-btn product-type-btn-outline" href="/products/custom-cufflinks-tie-clips/black-skull-logo-cufflinks">View More</a><a class="product-type-btn product-type-btn-primary" href="/contact">GET QUOTE NOW</a></div></article>
        </div>
      </div>
    </section>
