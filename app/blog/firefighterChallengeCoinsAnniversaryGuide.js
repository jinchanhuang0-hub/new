...
const firefighterAnniversaryImages = {
  hero: {
    ...
    alt: "Concept firefighter anniversary coins showing front and back designs beside a presentation box",
    caption: "Concept design showing two sides of a firefighter anniversary coin.",
  },
  versions: {
    ...
    alt: "Concept coin reverses with shared firehouse artwork and a blank personalization panel",
    caption: "Concept comparison of shared reverse artwork and a version with space reserved for personalization.",
  },
  artworkReview: {
    ...
    height: 1000,
    className: "blog-article-natural-image blog-image-3x2",
    alt: "Concept coin beside matching front and back artwork layouts on a review sheet",
    caption: "Illustrative artwork review setup; this image does not document an approved sample or inspection.",
  },
  packaging: {
    ...
    height: 1000,
    className: "blog-article-natural-image blog-image-3x2",
    alt: "Concept anniversary coin packaging in a clear pouch and an open navy presentation box",
    caption: "Concept packaging options for the same coin design; final fit should be checked against the finished coin.",
  },
};
