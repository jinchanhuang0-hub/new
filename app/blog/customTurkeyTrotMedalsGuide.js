      ...
      <div class="blog-article-shell">
        ...
        <div class="container blog-article blog-article-with-toc">
          ...
          <div class="blog-article-main">
            ...
            <p>Build the schedule around the proposed order, including any sampling, production, transit, and contingency time. Specify whether quoted durations use working or calendar days and what approval starts each stage. Production time alone does not establish an arrival date.</p>
            ...
            <p>A digital proof communicates the proposed design and specifications. If physical sampling is part of the order, schedule its review before bulk production. Design approval, quantity confirmation, and approval to proceed with bulk production may be separate checkpoints. Use our <a href="/blog/custom-medal-design-proof-checklist">medal artwork approval checklist</a> for the detailed review.</p>
            ...
            <section class="blog-article-cta blog-inquiry-cta turkey-trot-inquiry" aria-labelledby="plan-your-turkey-trot-medal-order">
              <div>
                ...
                <p>Send your race date, required delivery date, delivery destination, and estimated quantities for the 5K and kids’ run. Add your event artwork, sponsor requirements, and preferred medal and ribbon details. Our team can review the specifications and prepare a quote for your custom turkey trot medals.</p>
