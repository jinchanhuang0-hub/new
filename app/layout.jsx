...
})(window,document,'script','dataLayer','GTM-PVLJT85N');`
          }}
        />
        {/* End Google Tag Manager */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-4BPKLZFWYH"
          strategy="afterInteractive"
        />
        <Script id="ga4-direct-events" strategy="afterInteractive">
          {`
            window.dataLayer = window.dataLayer || [];
            window.gtag = window.gtag || function(){window.dataLayer.push(arguments);};
            window.gtag('js', new Date());
            window.gtag('config', 'G-4BPKLZFWYH', { send_page_view: false });
          `}
        </Script>
      </head>
      <body>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-PVLJT85N"
            height="0"
            width="0"
        ...
        <Script src="/script.js?v=20260722-2" strategy="afterInteractive" />
      </body>
    </html>
  );
}
