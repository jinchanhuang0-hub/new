    ...
    <section class="section about-profile-section" id="profile">
      <div class="container about-profile">
        <div class="about-profile-copy">
          ...
          <p>Zhongshan Unique Metal Gift Co., Ltd., a subsidiary of Caston established in 2003, is a professional manufacturer specializing in custom metal gifts and promotional products. We provide complete OEM and ODM solutions, covering product design, mold development, manufacturing, finishing processes, quality inspection, and global delivery.</p>
      ...
      <div class="container">
        <div class="cta-band">
          ...
          <div class="cta-actions">
            ...
            <a class="btn btn-outline" href="contact.html">Start Custom Order</a>
          </div>
        </div>
      </div>
    </section>
